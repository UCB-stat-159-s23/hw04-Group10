...
# function that plots the PSD of the spectral data

def sigplot(time, timemax, SNR, pcolor, det, eventname, fs, plottype, tevent, strain_whitenbp,template_match,template_fft, datafreq, d_eff, freqs, data_psd):
